...
<div class="display-message">
 <div class="message-display-head">
    ...
    <div class="btn-group pull-right hidden-xs">
        <a href="<?php echo base_url('index.php/message_control/reply_message/' . $msg->message_id); ?>" class="btn btn-sm btn-primary"><i class="fa fa-reply"></i><span class="invisible-on-md"> Reply </span></a>
        <a onclick="return delete_confirmation()" href="<?=base_url('index.php/message_control/delete_message/'.$msg->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i><span class="invisible-on-md"> Delete </span></a>
        <a href="<?php echo base_url('index.php/message_control/move_message/spam/' . $msg->message_id) ; ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-minus-sign"></i><span class="invisible-on-md"> Spam </span></a>
    </div>
</div>
<div class="row visible-xs">
    <div class="btn-group pull-right col-xs-pull-1">
        <a href="#" class="btn btn-sm btn-primary"><i class="fa fa-reply"></i> Reply </a>
        <a onclick="return delete_confirmation()" href="<?=base_url('index.php/message_control/delete_message/'.$msg->message_id); ?>" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-trash"></i> Delete </a>
