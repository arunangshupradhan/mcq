                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-center">
                                <p class="dashboard-heading"><?= $new_user; ?></p>
                            </div>
                            <div class="col-xs-12">
                                <p class="dashboard-text text-center">New Users</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-6 text-center">
                                <p class="dashboard-heading"><?= $new_exams; ?></p>
                            </div>
                            <div class="col-xs-12">
                                <p class="dashboard-text text-center">New Exams</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <p class="dashboard-text text-center">New Results</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="col-md-12">
    ...
    <div class="col-lg-4 col-md-12 col-sm-12">
    <div class="panel panel-primary"><!-- /.panel Start-->
    <div class="panel-heading">Earnings (last 6 months) <?=$this->session->userdata('currency_code') . ' ' . $this->session->userdata('currency_symbol');
?></div>
