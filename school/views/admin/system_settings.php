                ...
                <?php echo form_open(base_url().'index.php/admin/system_control/set_system_config', 'role="form" class="form-horizontal"'); ?>
                    ...
                    <div class="step-pane" id="step2">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                <label for="brand_slogan" class="col-md-2 col-md-offset-1 col-sm-3 control-label hidden-xs">Brand Slogan: </label>
                                <div class="col-md-8 col-sm-8 col-xs-10 col-xs-offset-1 col-sm-offset-0">
                                    <?php echo form_input('brand_slogan',  set_value('brand_slogan'), 'id="brand_slogan" placeholder="Brand Slogan" class="form-control"') ?>
                                </div>
                            </div>
                            <div class="form-group">
