...
<div class="block">  
    <div class="navbar block-inner block-header">
        <div class="row">
            <p class="text-muted">Mock Title: <?php echo (!empty($mock_title)) ? $mock_title->title_name : ''; ?> 
            <?php 
            if ($mock_title->user_id == $this->session->userdata['user_role_id']) {
            ?>
                <a class="btn custom_navbar-btn btn-primary pull-right col-sm-3" href="<?php echo base_url('index.php/admin_control/add_more_question') . '/' . $mock_title->title_id; ?>"><i class="glyphicon glyphicon-plus-sign"></i>&nbsp; Add More Question</a>
            <?php 
            } ?>
            </p>
        </div>
