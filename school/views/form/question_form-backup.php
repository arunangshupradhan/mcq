...
function add_form(val) {
  //  alert(val);
    ...
    for (q = 1; q <= 4; q++) {
        ...
        // opt += '<input type="file" multiple name="answer_image[]" id="answer_image">';
        ...
        opt += '</span>';
        if (q <= 2) {
            opt += '<input name="options[' + q + ']" class="form-control" type="text" required="required">You can add a image as a answer <input type="hidden" name="ans_id" value="' + q + '"><input type="file" name="answer_image[]" id="answer_image">';
        }
        if (q > 2) {
            opt += '<input name="options[' + q + ']" class="form-control" type="text">You can add a image as a answer <input type="hidden" name="ans_id" value="' + q + '"><input type="file" name="answer_image[]" id="answer_image">';
        }
        opt += '</div></div></div>';
    }
...
function add_field() {
    ...
    if (i <= 8) {
        ...
        str += '</span>';
        str += '<input name="options[' + i + ']" class="form-control" type="text">ou can add a image as a answer <input type="hidden" name="ans_id" value="[' + q + ']"><input type="file" name="answer_image[]" id="answer_image">';
...
<div class="block">
    ...
    <?=form_open_multipart(base_url('index.php/admin_control/create_question'), 'role="form" class="form-horizontal"'); ?>
    <div class="row">
    <div class="col-sm-12">
        <div class="row">
        ...
        <div class="row">
            ...
            <input type="hidden" name="ques_id" value="<?php echo $title_id; ?>">
            <input type="hidden" name="mock_title" value="<?php echo $mock_title; ?>">
            ...
            <div class="form-group" id="media-choose">
                <label for="upload-media-file" name="go_upload" class="col-sm-offset-0 col-lg-2 col-xs-offset-1 col-xs-3 control-label mobile">Upload Media File: </label>
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb">
            ...
            <div class="form-group">
                ...
                <div class="col-lg-5 col-sm-8 col-xs-7 col-mb" style="display: inline-flex;">
            ...
            <div class="row">
                <div class="col-xs-offset-1 col-xs-11 col-sm-offset-2 col-md-8">
                    <button type="submit" name="go_upload" class="btn btn-primary col-xs-5 col-sm-3">Next <i class="glyphicon glyphicon-hand-right"></i></button>
