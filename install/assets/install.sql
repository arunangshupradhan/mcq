...
INSERT INTO `settings` (`brand_id`, `brand_name`, `brand_slogan`, `local_time_zone`, `support_email`, `support_phone`, `address`, `facbook_url`, `googleplus_url`, `linkedin_url`, `you_tube_url`, `flickr_url`, `twitter_url`, `pinterest_url`, `show_video_on_home`, `student_can_register`, `last_update`, `commercial`) VALUES
...
--
ALTER TABLE `answers`
MODIFY `ans_id` int(5) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=142;
--
