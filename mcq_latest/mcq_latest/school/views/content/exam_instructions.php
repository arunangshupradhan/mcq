...
<div class="container">
    <div class="col-md-12">
        <p class="lead"><span class="text-muted">Exam Title: </span> <?= $mock->title_name ?></p>
    </div>
</div>
<div class="container">
    <div class="col-md-12">
...
<div class="container">
    <a href="<?=base_url('index.php/exam_control/start_exam/'.$mock->title_id) ?>" id="start-exam" class="btn btn-lg btn-success col-xs-5 col-xs-offset-1">Start Exam</a>    
    <a href="<?=base_url('index.php/exam_control/view_all_mocks') ?>" class="btn btn-lg btn-default col-xs-offset-1">Cancel</a>    
</div><br/><br/>
<div class="container">
