            ...
            foreach ($categories as $category) { ?>
              <?php if ($category->category_active == 0) {?>  
                <tr class="<?=($i & 1) ? 'even' : 'odd'; ?>">
                    ...
                    <td style="width: 13%">
                        <a class="btn btn-primary" href = "<?php echo base_url('index.php/admin_control/activate_category/' . $category->category_id); ?>"><i class="glyphicon glyphicon-check"></i><span class="invisible-on-md">  Activate </span></a>
                    </td>
                </tr>
                <?php $i++;
                }
