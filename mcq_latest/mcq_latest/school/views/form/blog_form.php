...
<div class="block">
    ...
    <form action="<?php echo base_url().'index.php/blog/save'?>" method="post" id="ajax-form" role="form" class="form-horizontal">  
    <div class="row">
    <div class="col-sm-12">
        <div class="row">
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-lg-6 col-sm-8 col-xs-7 col-mb">
                    <?php echo form_input('blog_title', set_value('blog_title'), 'placeholder="Blog title" id="title" class="form-control" required="required"') ?>
                </div>
            </div>
            <div class="form-group">
